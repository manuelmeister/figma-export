                ...
                switch (style.styleType) {
                    case 'FILL': {
                        const value = style.fills
                            ...
                            .map((fill) => fill.value)
                            .join(', ');
                        text += utils_1.writeVariable(style.comment, style.name, value);
                        break;
                    }
                    case 'EFFECT': {
                        ...
                        text += utils_1.writeVariable(style.comment, style.name, boxShadowValue || filterBlurValue);
                        break;
                    }
                    case 'TEXT': {
                        const value = `{
                        ...
                        text += utils_1.writeMap(style.comment, style.name, value);
                        break;
                    }
                }
            }
